...
class DatabaseSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $dataPermissions = [
            ...
            ['parent_id'=>10,'name'=>'List Menu','display_name'=>'Danh sách menu','key_code'=>'list_menu'],
            ['parent_id'=>10,'name'=>'Add Menu','display_name'=>'Thêm menu','key_code'=>'add_menu'],
            ['parent_id'=>10,'name'=>'Edit Menu','display_name'=>'Sửa menu','key_code'=>'edit_menu'],
            ['parent_id'=>10,'name'=>'Delete Menu','display_name'=>'Xóa menu','key_code'=>'delete_menu'],
            ['parent_id'=>10,'name'=>'List Slide','display_name'=>'Danh sách Slide','key_code'=>'list_slide'],
            ['parent_id'=>10,'name'=>'Add Slide','display_name'=>'Thêm Slide','key_code'=>'add_slide'],
            ['parent_id'=>10,'name'=>'Edit Slide','display_name'=>'Sửa Slide','key_code'=>'edit_slide'],
            ['parent_id'=>10,'name'=>'Delete Slide','display_name'=>'Xóa Slide','key_code'=>'delete_slide'],
            ['parent_id'=>10,'name'=>'List Information','display_name'=>'Danh sách thông tin','key_code'=>'list_information'],
            ['parent_id'=>10,'name'=>'Add Information','display_name'=>'Thêm thông tin','key_code'=>'add_information'],
            ['parent_id'=>10,'name'=>'Edit Information','display_name'=>'Sửa thông tin','key_code'=>'edit_information'],
            ['parent_id'=>10,'name'=>'Delete Information','display_name'=>'Xóa thông tin','key_code'=>'delete_information'],
            ['parent_id'=>0,'name'=>'Account Management','display_name'=>'Quản lý tài khoản','key_code'=>''],
            ['parent_id'=>23,'name'=>'List Accounts','display_name'=>'Danh sách tài khoản','key_code'=>'list_user'],
            ['parent_id'=>23,'name'=>'Add Accounts','display_name'=>'Thêm tài khoản','key_code'=>'add_user'],
            ['parent_id'=>23,'name'=>'Edit Accounts','display_name'=>'Sửa tài khoản','key_code'=>'edit_user'],
            ['parent_id'=>23,'name'=>'Delete Accounts','display_name'=>'Xóa tài khoản','key_code'=>'delete_user'],
            ['parent_id'=>23,'name'=>'List Roles','display_name'=>'Danh sách vai trò','key_code'=>'list_role'],
            ['parent_id'=>23,'name'=>'Add Roles','display_name'=>'Thêm vai trò','key_code'=>'add_role'],
            ['parent_id'=>23,'name'=>'Edit Roles','display_name'=>'Sửa vai trò','key_code'=>'edit_role'],
            ['parent_id'=>23,'name'=>'Delete Roles','display_name'=>'Xóa vai trò','key_code'=>'delete_role'],
            ['parent_id'=>23,'name'=>'Add Permissions','display_name'=>'Thêm Quyền','key_code'=>'add_permission'],
        ];
        $dataPermissionRole = [
