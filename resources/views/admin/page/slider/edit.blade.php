...
@section('content')
    ...
    <div class="content-wrapper">
        @include('admin.partials.header-page', ['name'=> 'Chỉnh Sửa Slider', 'key' => false, 'route' => null])
                            ...
                            <form action="{{ route('sliders.update', ['id' => $slider->id]) }}" method="post">
                                ...
                                <div class="card-body">
                                    <div class="form-group">
                                        <label for="name_menu">Tên danh mục</label>
                                        <input type="text" class="form-control"
                                               id="name_menu" name="name" placeholder="Tên danh mục" value="{{ $slider->name }}"
                                        ...
                                        <label class="d-flex align-items-center"><small>Slug:</small>
                                            <input type="text" class="form-control form-control-border form-control-sm bg-white border-bottom-0"
                                                   id="slug_menu" name="slug" placeholder="slug-name" value="{{ $slider->slug }}" readonly="readonly">
                                        </label>
                                    </div>
                                    <div class="form-group">
