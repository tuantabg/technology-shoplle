                                ...
                                <div class="card-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea id="image_description"
                                                  ...
                                                  name="description">{!! $slider->description !!}
                                        </textarea>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div id="image_upload_file" class="input-group bg-white @error('image_path') border-danger @enderror">
                                            <input id="upload" type="file" onchange="readURL(this);"
                                                   class="form-control border-0" name="image_path" value="{{ $slider->image_path }}">
                                            <label id="upload-label" for="upload"
                                                   class="font-weight-light text-muted">
                                                {{ $slider->image_path ? 'Tên tập tin: ' . $slider->image_name : 'Tải hình ảnh' }}
                                            </label>
